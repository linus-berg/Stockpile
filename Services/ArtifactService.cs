...
namespace Stockpile.Services {
  public class ArtifactService {
    ...
    private Main config_;
    private Fetcher fetcher_config_;
    private CommonOptions options_;
    private BaseChannel channel_;
    
    public ArtifactService(Main config, string channel_id) {
      config_ = config;
      fetcher_config_ = config_.GetChannelConfig(channel_id);
      RunSetup();
    }    
    public ArtifactService(Main config, Fetcher fetcher_config) {
      config_ = config;
